...
import static science.atlarge.opencraft.opencraft.GlowServer.getWorldConfig;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_BIG_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_BIG_HILLS2;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_DEEP_OCEAN;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_DEFAULT;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_DEFAULT_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_EXTREME_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_FLATLANDS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_FLATLANDS_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_FLAT_SHORE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_HIGH_PLATEAU;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_HIGH_SPIKES;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_LOW_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_LOW_SPIKES;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_MID_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_MID_HILLS2;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_MID_PLAINS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_OCEAN;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_RIVER;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_ROCKY_SHORE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_SWAMPLAND;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_HEIGHT_SWAMPLAND_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_BIG_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_BIG_HILLS2;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_DEEP_OCEAN;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_DEFAULT;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_DEFAULT_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_EXTREME_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_FLATLANDS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_FLATLANDS_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_FLAT_SHORE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_HIGH_PLATEAU;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_HIGH_SPIKES;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_LOW_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_LOW_SPIKES;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_MID_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_MID_HILLS2;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_MID_PLAINS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_OCEAN;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_RIVER;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_ROCKY_SHORE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_SWAMPLAND;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.BIOME_SCALE_SWAMPLAND_HILLS;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_BASE_SIZE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_BIOME_HEIGHT_OFFSET;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_BIOME_HEIGHT_WEIGHT;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_BIOME_SCALE_OFFSET;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_BIOME_SCALE_WEIGHT;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_COORDINATE_SCALE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_DENSITY_FILL_MODE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_DENSITY_FILL_OFFSET;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_DENSITY_FILL_SEA_MODE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_DETAIL_NOISE_SCALE_X;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_DETAIL_NOISE_SCALE_Y;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_DETAIL_NOISE_SCALE_Z;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_HEIGHT_NOISE_SCALE_X;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_HEIGHT_NOISE_SCALE_Z;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_HEIGHT_SCALE;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_STRETCH_Y;
import static science.atlarge.opencraft.opencraft.util.config.WorldConfig.Key.OVERWORLD_SURFACE_SCALE;
